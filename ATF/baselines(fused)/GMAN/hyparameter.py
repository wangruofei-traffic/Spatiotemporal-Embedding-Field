...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/yinchuan-3/GMAN', help='save path')
        self.parser.add_argument('--model_name', type=str, default='GMAN', help='training or testing model name')
        self.parser.add_argument('--file_train_f', type=str, default='data/yinchuan/traffic_with_embedding.csv', help='training_speed file address')
        ...
        self.parser.add_argument('--epoch', type=int, default=1000, help='epoch') # modify
        self.parser.add_argument('--step', type=int, default=1, help='step')
        self.parser.add_argument('--batch_size', type=int, default=64, help='batch size')  # modify
        ...
        self.parser.add_argument('--features', type=int, default=33, help='numbers of the feature')
