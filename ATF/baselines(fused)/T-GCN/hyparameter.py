...
class parameter(object):
    def __init__(self,parser):
        ...
        self.parser.add_argument('--save_path', type=str, default='weights/tgcn-2', help='save path')
        self.parser.add_argument('--model_name', type=str, default='tgcn', help='training or testing model name')
        self.parser.add_argument('--file_train_s', type=str, default='data/ningxia-yc/traffic_with_embedding.csv', help='training_speed file address')
