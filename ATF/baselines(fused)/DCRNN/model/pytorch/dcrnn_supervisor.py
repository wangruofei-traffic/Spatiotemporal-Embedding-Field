...
class DCRNNSupervisor:
    ...
    def _setup_graph(self):
        with torch.no_grad():
            ...
            for _, (x, y) in enumerate(val_iterator):
                ...
                output = self.dcrnn_model(x,y) #为何要这步处理？？
                break
    ...
    def _compute_loss(self, y_true, y_predicted):
        ...
        #print("🔹 y_true2:", y_true.shape)
        #print("🔹 y_predicted3:", y_predicted.shape)
        y_true = self.standard_scaler.inverse_transform(y_true)
        y_predicted = self.standard_scaler.inverse_transform(y_predicted)
        return masked_mae_loss(y_predicted, y_true)

    def _compute_metrics(self, y_true, y_predicted):
        #print("🔹 y_true4:", y_true.shape)
        #print("🔹 y_predicted5:", y_predicted.shape)

        y_true = y_true[..., 0]  # 取第一个特征
        #print("🔹 y_true6:", y_true.shape)
        #print("🔹 y_predicted4:", y_predicted.shape)
        y_true = self.standard_scaler.inverse_transform(y_true)
        y_predicted = self.standard_scaler.inverse_transform(y_predicted)
