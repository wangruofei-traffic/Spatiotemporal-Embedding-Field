...
parser.add_argument('--weight_decay',type=float,default=0.0001,help='weight原始 decay rate')
...
def main(runid):
    patience = 20  # 允许连续多少个 epoch 验证 loss 没下降
    counter = 0
    best_loss = 1e5
    ...
    for i in range(1,args.epochs+1):
        ...
        if mvalid_loss < best_loss:
            ...
            counter = 0
            print('Val loss decrease, saving model to {}'.format(args.save + args.data.split('/')[-1]))
